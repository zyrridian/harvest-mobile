...
class DropPointsScreen extends ConsumerWidget {
        ...
        error: (error, _) => Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () => ref
                    .read(dropPointsControllerProvider.notifier)
                    .fetchDropPoints(),
          ...
          if (points.isEmpty) {
            return Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  PhosphorIcon(PhosphorIconsRegular.mapTrifold,
                      size: 64, color: kTextGrey),
                  const SizedBox(height: 16),
                  Text(
                    'No Drop Points yet',
                    style: TextStyle(
  ...
  Widget _buildDropPointCard(
      BuildContext context, WidgetRef ref, DropPoint point) {
    return Container(
                      ...
                      onPressed: () {
                        ...
                        showDialog(
                          ...
                          builder: (ctx) => AlertDialog(
                            ...
                            content: const Text(
                                'Are you sure you want to delete this drop point?'),
                            actions: [
                              TextButton(
                              ...
                              TextButton(
                                onPressed: () {
                                  ref
                                      .read(
                                          dropPointsControllerProvider.notifier)
                                      .deleteDropPoint(point.id);
                                  Navigator.pop(ctx);
                                },
