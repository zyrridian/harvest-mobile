...
class _CreatePostScreenState extends ConsumerState<CreatePostScreen> {
  ...
  Future<void> _submitPost() async {
    ...
    result.fold(
      ...
      (post) {
        Navigator.pop(
            context, true); // Return true to indicate success and refresh feed
      },
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: RichText(
                  text: TextSpan(
                    style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                        color: kDarkGreen, fontSize: 13, height: 1.5),
                    children: const [
                      TextSpan(
                          text: 'Tip: ',
                      ...
                      TextSpan(
                          text:
                              'The community is a shared space for both farmers and consumers. If you run a farm, your posts will automatically be tagged with your farm\'s badge!'),
                    ],
                  ),
                ),
              ),
