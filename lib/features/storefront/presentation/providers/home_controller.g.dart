...
String _$homeRepositoryHash() => r'ac5464564ecfdccfed048552db12905e49dd52d7';
...
String _$getHomeUseCaseHash() => r'd8c3463d6e7f15b11e066df20f9840d5caa1c204';

/// See also [getHomeUseCase].
@ProviderFor(getHomeUseCase)
final getHomeUseCaseProvider = AutoDisposeProvider<GetHomeUseCase>.internal(
  getHomeUseCase,
  name: r'getHomeUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$getHomeUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
