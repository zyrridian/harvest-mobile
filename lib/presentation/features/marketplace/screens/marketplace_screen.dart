            ...
            child: Stack(
              ...
              children: [
                Container(
                  ...
                  child: const Icon(Icons.shopping_bag_outlined, color: kDarkGreen),
                ),
                Positioned(
                  top: 8,
                  right: -2,
                  ...
                  if (data.flashHarvest != null)
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            color: const Color(0xFF28482A), // Dark green background
                          ...
                          child: Stack(
                            children: [
                              ...
                              Positioned(
                                ...
                                top: 10,
                                child: Text(
                                  data.flashHarvest!.imageUrl, // Using emoji directly
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: data.categories.map((cat) => _buildCategoryItem(cat)).toList(),
                          ),
                        ],
                      ),
                    ),
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverGrid(
                      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        crossAxisSpacing: 16,
                        mainAxisSpacing: 16,
                        childAspectRatio: 0.65, // Adjust to fit content based on image
                      ),
                      delegate: SliverChildBuilderDelegate(
                        (context, index) {
                          return _buildProductCard(data.products[index]);
                        },
                        childCount: data.products.length,
                      ),
                    ),
                  ),
                  const SliverToBoxAdapter(child: SizedBox(height: 100)), // Bottom padding for cart button
                ],
              ),
              // Floating Cart Bar
              Positioned(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.inter(
                            color: const Color(0xFFD4A373), // A golden-like color based on the design
                            fontSize: 14,
                            fontWeight: FontWeight.bold,
                            height: 1.2,
                          ),
