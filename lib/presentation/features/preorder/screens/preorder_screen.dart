...
class _PreOrderScreenState extends ConsumerState<PreOrderScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: state.when(
        ...
        loading: () => const Center(child: CircularProgressIndicator(color: kTextGreen)),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          _buildStatColumn('${data.activeHarvests}', 'Active harvests'),
                          _buildStatColumn('${data.yourReservations}', 'Your reservations', isHighlight: true),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          'See all',
                          style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w600, color: kTextGreen),
                        ),
                      ),
                    ],
                  ),
                      ...
                      children: data.activeReservations.map((res) {
                        ...
                        return Column(
                          children: [
                            ...
                            if (!isLast) const Divider(height: 1, indent: 64, endIndent: 16, color: Color(0xFFEEEEEE)),
                          ],
                        );
                      }).toList(),
                    ),
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Icon(Icons.info_outline, color: Color(0xFFD4A373), size: 20),
    ...
    return Column(
      ...
      children: [
        Text(
          value,
          style: GoogleFonts.inter(
            color: isHighlight ? const Color(0xFFE89A33) : const Color(0xFFD4A373),
            fontSize: 24,
            fontWeight: FontWeight.bold,
          ),
        ),
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
                    decoration: BoxDecoration(
                      color: harvest.status == 'Almost full' ? const Color(0xFFFDECE8) : const Color(0xFFF0FDF4),
                      borderRadius: BorderRadius.circular(8),
                    ),
                    child: Row(
                      children: [
                        if (harvest.status == 'Almost full') const Text('🔥', style: TextStyle(fontSize: 10)),
                        if (harvest.status == 'Almost full') const SizedBox(width: 4),
                        Text(
                          harvest.status,
                          style: GoogleFonts.inter(
                            color: harvest.status == 'Almost full' ? const Color(0xFFD94A38) : const Color(0xFF15803D),
                            fontSize: 10,
                            fontWeight: FontWeight.w600,
                          ),
                        ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  harvest.title,
                  style: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.bold, color: kTextGreen),
                ),
                const SizedBox(height: 4),
                Row(
                  children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.inter(fontSize: 11, fontWeight: FontWeight.bold, color: kTextGreen),
                    ),
                  ],
                ),
                ...
                LinearProgressIndicator(
                  ...
                  valueColor: const AlwaysStoppedAnimation<Color>(Color(0xFF386824)),
                  minHeight: 6,
                      ...
                      children: [
                        Text.rich(
                          TextSpan(
                            children: [
                              TextSpan(
                                text: formatter.format(harvest.price).replaceAll(',00', ''),
                                style: GoogleFonts.inter(
                                  color: kTextGreen,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 16,
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Center(
              child: Text(reservation.imageUrl, style: const TextStyle(fontSize: 20)),
            ),
          ),
          const SizedBox(width: 12),
          Expanded(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: reservation.status == 'Confirmed' ? const Color(0xFFF0FDF4) : const Color(0xFFFFF7ED),
              borderRadius: BorderRadius.circular(8),
            ),
            child: Text(
              reservation.status,
              style: GoogleFonts.inter(
                color: reservation.status == 'Confirmed' ? const Color(0xFF15803D) : const Color(0xFFC2410C),
                fontSize: 10,
                fontWeight: FontWeight.w600,
              ),
            ),
