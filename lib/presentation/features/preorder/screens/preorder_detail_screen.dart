...
class _PreOrderDetailScreenState extends State<PreOrderDetailScreen> {
  ...
  // Mock data tailored for the Pre-Order concept
  final String title = 'Premium Grade A Tomat';
  final String farmName = 'Green Valley Farm';
  final double price = 50000;
  final int daysLeft = 14;
  final double progress = 4;
  final int remainingKg = 96;
  final int totalKg = 100;
  final String imageUrl = 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=500&q=80';
  final bool hasReserved = true; // Mock status
          ...
          SliverAppBar(
            ...
            leading: IconButton(
              icon: Container(
                ...
                child: const PhosphorIcon(PhosphorIconsRegular.caretLeft, color: kDarkGreen, size: 20),
              ),
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          const PhosphorIcon(PhosphorIconsRegular.calendarCheck, size: 18, color: kDarkGreen),
                ...
                children: [
                  if (hasReserved)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color(0xFFF0EAD6), // Sand color from home theme
                        borderRadius: BorderRadius.circular(12),
                      ),
                      child: Row(
                        children: [
                          const PhosphorIcon(PhosphorIconsFill.checkCircle, color: kDarkGreen),
                  ...
                  Row(
                    ...
                    children: [
                            ...
                            Row(
                              ...
                              children: [
                                const Padding(
                                  ...
                                  child: PhosphorIcon(PhosphorIconsRegular.mapPin, size: 12, color: Color(0xFFD97706)),
                                ),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            const PhosphorIcon(PhosphorIconsRegular.leaf, size: 16, color: kDarkGreen),
                            const SizedBox(width: 4),
                            Text(
                              'Direct from Farm',
                              style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                            image: NetworkImage('https://images.unsplash.com/photo-1595878715977-2e8f8df18ea8?w=150&q=80'),
                            fit: BoxFit.cover,
                          ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                const PhosphorIcon(PhosphorIconsRegular.plant, size: 12, color: kDarkGreen),
                                const SizedBox(width: 4),
                                Text(
                  ...
                  const SizedBox(height: 120), // Padding to account for the bottom sheet
                ],
              ),
            ),
          ),
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF166534), // Primary green
